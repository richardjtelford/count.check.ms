...
Some datasets with a high proportion of assemblages with a greatest common divisor above one are older datasets which may, despite the available metadata, have been back-transformed from percent data or digitised with the loss of rare taxa and precision.
...
It seems likely that the data were converted to percent, rounded and then back-tranformed to counts.
