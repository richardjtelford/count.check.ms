...
The assemblages with a greatest common divisor above one are not randomly distributed among the datasets: `r pollen_summ$dataset_gcd1`% of the datasets have no such assemblages.
...
Analysis of the breeding bird, Owen's Lake diatom, testate amoeba and pollen data sets has shown that, as expected, the vast majority of community and assemblages counts have singletons, and an even larger proportion have a greatest common divisor of one. 
...
However, as taxonomically diverse assemblages with a greatest common divisor greater than one are rare and all the datasets with apparently low count sums contained multiple taxonomically diverse assemblages with apparently low count sums, this is unlikely. 
...
None of the `r chironomid2_summ$n_samp` assemblages in the dataset had more fifty chironomids: the count sums varied between `r chironomid2_summ$count_min` and  `r chironomid2_summ$count_max`. 
