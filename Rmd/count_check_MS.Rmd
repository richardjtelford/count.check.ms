...
Dataset pollen3, published includes `r pollen3$n_samp` assemblages with a median richness of `r pollen3$taxa_median` taxa.
Count sums vary between `r pollen3$count_min` and `r pollen3$count_max`.
The greatest common divisor is three for all assemblages: all `r pollen3$n_count` counts in the dataset are divisible by three. 
...
For a dataset this large, the probability of having all counts divisible by three by chance is 10^`r ceiling(- pollen3$n_count * log10(3))`^.
